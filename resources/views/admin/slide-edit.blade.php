    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.slide.update')}}" method="POST" enctype="multipart/form-data">
                ...
                @error("tagline") <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error("title") <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error("subtitle") <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error("link") <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
                ...
                @error("status") <span class="alert alert-danger text-danger">{{$message}}</span> @enderror
