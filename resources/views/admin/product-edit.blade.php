                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{$product->stock_status == "instock" ? "seletecd":""}}>InStock</option>
                                <option value="outofstock" {{$product->stock_status == "outofstock" ? "seletecd":""}}>Out of Stock</option>
                            </select>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="featured">
                                <option value="0" {{$product->featured == "0" ? "seletecd":""}}>No</option>
                                <option value="1" {{$product->featured == "1" ? "seletecd":""}}>Yes</option>
                            </select>
                        </div>
                    </fieldset>
